...
tezos-client -E https://localhost:20000 originate contract main transferring 1 from alice running ./contracts/main.tz --init "`cat ./contracts/main_storage.tz`" --burn-cap 2 --force
