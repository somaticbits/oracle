...
<h3 align="center">Tezos Blockchain Oracle for the Arts</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/somaticbits/oracle"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/somaticbits/oracle">View Demo</a>
    ·
    <a href="https://github.com/somaticbits/oracle/issues">Report Bug</a>
    ·
    <a href="https://github.com/somaticbits/oracle/issues">Request Feature</a>
  </p>
</div>
